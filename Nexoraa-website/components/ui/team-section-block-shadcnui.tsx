...
const teamMembers = [
  {
    ...
    bio: "Processes large datasets and generates actionable insights",
    image: "https://api.dicebear.com/7.x/bottts/svg?seed=Priya",
    location: "Data Center US-East",
    skills: ["Pandas", "Scikit-Learn", "Visualization"],
    gradient: "from-blue-500/10 via-blue-500/5 to-transparent",
    social: {
      twitter: "#",
      linkedin: "#",
      github: "#",
      email: "priya@agents.neuralforge.com",
    },
  },
  {
    name: "Arjun",
    role: "AI Content Creator",
    bio: "Generates high-converting copy and technical documentation",
    image: "https://api.dicebear.com/7.x/bottts/svg?seed=Arjun",
    location: "Data Center EU-West",
    skills: ["NLP", "Copywriting", "SEO"],
    gradient: "from-purple-500/12 via-purple-500/5 to-transparent",
    social: {
      twitter: "#",
      linkedin: "#",
      github: "#",
      email: "arjun@agents.neuralforge.com",
    },
  },
  {
    name: "Kiran",
    role: "AI Code Reviewer",
    bio: "Scans pull requests for security flaws and performance issues",
    image: "https://api.dicebear.com/7.x/bottts/svg?seed=Kiran",
    location: "Data Center AP-South",
    skills: ["Security", "Optimization", "Linting"],
    gradient: "from-emerald-500/12 via-emerald-500/5 to-transparent",
    social: {
      twitter: "#",
      linkedin: "#",
      github: "#",
      email: "kiran@agents.neuralforge.com",
    },
  },
  {
    name: "Dev",
    role: "MLOps Engineer",
    bio: "Manages model deployments, scaling, and infrastructure",
    ...
    social: {
      ...
      linkedin: "#",
      github: "#",
      email: "dev@agents.neuralforge.com",
    },
  },
];
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <Card className="inline-flex flex-col items-center gap-6 rounded-3xl border border-border/60 bg-card/80 px-10 py-8 shadow-[0_20px_70px_-30px_rgba(15,23,42,0.6)] backdrop-blur-xl">
            <h3 className="text-2xl font-semibold">Deploy Your First Agent</h3>
            ...
            >
              ...
              />
              <span className="relative font-medium">Explore Agent Marketplace</span>
              <motion.span
