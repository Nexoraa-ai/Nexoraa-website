...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    '--step': '5%',
    '--foil-svg': `url("data:image/svg+xml,%3Csvg width='26' height='26' viewBox='0 0 26 26' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M2.99994 3.419C2.99994 3.419 21.6146 7.43646 22.7921 12.153C23.9696 16.8696 3.419 21.6146 3.419 21.6146' stroke='white' stroke-width='0.5' stroke-opacity='0.2' stroke-linejoin='round'/%3E%3C/svg%3E")`,
  ...
  return (
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-y))_rotateX(var(--r-x))] rounded-[var(--radius)] border border-white/5 hover:[--opacity:0.6] hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden">
        ...
        <div className="w-full h-full grid [grid-area:1/1]">
          <div className={cn("relative w-full h-full bg-slate-950 rounded-[var(--radius)] z-10", className)}>
            {children}
          </div>
        </div>
      </div>
